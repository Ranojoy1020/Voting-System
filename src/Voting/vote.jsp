...
<body>
    ...
    <form class = "main" action = "submitVote.jsp" method = "get">
                ...
                %>
                    ...
                    <div class = "categoryTable">
                        ...
                        <%    while(GSresult.next()){ %>
                                ...
                                <td>
                                    <input type="radio" name="gs" value= <%=GSresult.getInt("candidate_ID") %>
                                </td>
                                </tr>
                        <%    } %>
                        </table>
                    ...
                    <div class = "categoryTable">
                        ...
                        <%    while(LRresult.next()){ %>
                            ...
                            <!--<td>
                                ...
                                <td>
                                    <input type="radio" name="lr" value= <%=LRresult.getInt("candidate_ID") %>
                                </td>
                                </tr>
                        <%    } %>
                        </table>
                ...
                %>
                    <div class = "categoryTable">
                        ...
                        <%    while(TSresult.next()){ %>
                                ...
                                <td>
                                    <input type="radio" name="ts" value= <%=TSresult.getInt("candidate_ID") %>
                                </td>
                                </tr>
                        <%    } %>
                        </table>
                ...
                %>
                    <div class = "categoryTable">
                        ...
                        <%    while(SSresult.next()){ %>
                                ...
                                <td>
                                    <input type="radio" name="ss" value= <%=SSresult.getInt("candidate_ID") %>
                                </td>
                                </tr>
                        <%    } %>
                        </table>
                ...
                %>
                    <div class = "categoryTable">
                        ...
                        <%    while(CSresult.next()){ %>
                                ...
                                <td>
                                    <input type="radio" name="cs" value= <%=CSresult.getInt("candidate_ID") %>
                                </td>
                                </tr>
                        <%    } %>
                        </table>
                ...
                %>
                    <div class = "categoryTable">
                        ...
                        <%    while(NSresult.next()){ %>
                                ...
                                <td>
                                    <input type="radio" name="ns" value= <%=NSresult.getInt("candidate_ID") %> />
                                </td>
                                </tr>
                        <%    } %>
                        </table>
